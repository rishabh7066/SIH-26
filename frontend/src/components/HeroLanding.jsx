    ...
    <div style={{ 
      ...
      <section style={{ position: 'relative', width: '100%' }}>
        <div className="hero-image-frame" style={{ height: 'clamp(320px, 45vw, 520px)' }}>
          ...
          <img 
            src="https://images.unsplash.com/photo-1595278069441-2cf29f8005a4?auto=format&fit=crop&w=1400&q=80" 
            alt="GramVenture AI Rural Indian Entrepreneurship"
            loading="lazy"
            onError={(e) => {
              e.target.src = 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=1400&q=80';
            }}
          />
