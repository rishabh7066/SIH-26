...
export default function FeasibilityDashboard({ 
  ...
  const currentVillage = assessmentData.village || "Adampur";
  const currentBlock = assessmentData.block || "Sewapuri";
  const currentDistrict = assessmentData.district || "Varanasi";
                ...
                <div className="glass-panel" style={{ padding: '24px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                    <div>
                      <h3 style={{ fontSize: '1.15rem', color: '#14532d', margin: 0 }}>
                        10 किमी के दायरे में बाज़ार और दुकानें
                      </h3>
                      <p style={{ fontSize: '0.8rem', color: '#64748b', margin: '4px 0 0 0' }}>
                        आदमपुर, कपसेठी मंडी और जीटी रोड के आस-पास का नज़ारा
                      </p>
                    </div>
                    <div style={{ display: 'flex', gap: '6px' }}>
                  ...
                  <div style={{
                    ...
                    <svg width="100%" height="100%" style={{ position: 'absolute', top: 0, left: 0 }}>
                      <defs>
                        <radialGradient id="satHigh" cx="30%" cy="40%" r="35%">
                          <stop offset="0%" stopColor="#ef4444" stopOpacity="0.3" />
                          <stop offset="100%" stopColor="#ef4444" stopOpacity="0" />
                        </radialGradient>
                        <radialGradient id="oppHigh" cx="75%" cy="65%" r="35%">
                          <stop offset="0%" stopColor="#22c55e" stopOpacity="0.35" />
                          <stop offset="100%" stopColor="#22c55e" stopOpacity="0" />
                        </radialGradient>
                      </defs>

                      <path d="M 50 180 Q 250 160 550 210" stroke="#cbd5e1" strokeWidth="6" fill="none" />
                      <path d="M 300 30 Q 320 200 340 370" stroke="#cbd5e1" strokeWidth="5" fill="none" />
                      <path d="M 500 50 L 520 350" stroke="#e2e8f0" strokeWidth="4" strokeDasharray="5,5" fill="none" />

                      <circle cx="280" cy="170" r="140" fill="url(#satHigh)" />
                      <circle cx="500" cy="240" r="130" fill="url(#oppHigh)" />
                    </svg>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        justifyContent: 'center',
                        margin: '0 auto',
                        boxShadow: '0 0 16px rgba(21, 128, 61, 0.7)',
                        border: '3px solid #ffffff'
                      }}>
                        🌾
                      </div>
                      <span style={{ fontSize: '0.72rem', fontWeight: 700, background: '#ffffff', padding: '2px 8px', borderRadius: '4px', border: '1px solid #cbd5e1', marginTop: '4px', display: 'inline-block' }}>
                        {currentVillage} (आपका स्थान)
                      </span>
                    </div>

                    <div style={{ position: 'absolute', top: '25%', left: '20%', background: 'rgba(254, 242, 242, 0.9)', padding: '6px 10px', borderRadius: '8px', border: '1px solid #fecaca', fontSize: '0.72rem' }}>
                      <strong style={{ color: '#b91c1c' }}>ब्लॉक मुख्यालय (बाज़ार)</strong><br />
                      दुकानें: बहुत ज़्यादा | आबादी: ज़्यादा<br />
                      मुनाफे का मौका: <span style={{ color: '#b45309', fontWeight: 600 }}>मध्यम</span>
                    </div>

                    <div style={{ position: 'absolute', top: '55%', left: '65%', background: 'rgba(240, 253, 244, 0.9)', padding: '6px 10px', borderRadius: '8px', border: '1px solid #bbf7d0', fontSize: '0.72rem' }}>
                      <strong style={{ color: '#166534' }}>हाईवे और आवासीय क्षेत्र</strong><br />
                      दुकानें: बहुत कम | ग्राहक: ज़्यादा<br />
                      मुनाफे का मौका: <span style={{ color: '#15803d', fontWeight: 800 }}>बहुत बढ़िया (पनीर व डिलीवरी)</span>
                    </div>

                    {COMPETITORS_MOCK.map((c, i) => (
                      <div 
                        key={c.id}
                        style={{
                          position: 'absolute',
                      ...
                      >
                        <span>🏪</span>
                        <span>{c.name} ({c.distKm} किमी)</span>
                      </div>
                    ))}
                  </div>
                </div>
